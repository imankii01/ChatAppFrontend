...
const Home = () => {
  ...
  return (
    ...
    <motion.header variants={stagger}>
        <motion.div className="logo_wrapper" variants={header}>Gup<span>Chup</span></motion.div>
    ...
    <motion.div className="content_wrapper" initial={{opacity:0,scale:0}} animate={{opacity:1, scale:1}} transition={{duration:0.3, ease:easeing}}>
      <div className="left_content_wrapper">
        ...
        <motion.h2>
          ...
          <motion.span variants={firstName} initial="initial" animate="animate" className='first'>
              ...
              <motion.span variants={letter}>u</motion.span>
              <motion.span variants={letter}>p</motion.span>
              <motion.span variants={letter} className="second">H</motion.span>
        ...
        <motion.p variants={fadeInUp}>Join GupChup today and experience seamless communication with <br/> the peace of mind that your conversations are protected by top-notch security measures</motion.p>

        <motion.div className="btn_group" variants={stagger}>
          <motion.div className="btn btn_primary" variants={btnGroup} whileHover={{scale:1.05}} whileTap={{scale:0.95}}>Login
            <IconContext.Provider value={{color:"#14da8f", size:"25px"}}>
              <IoChevronForwardCircle/>
            </IconContext.Provider>
          </motion.div>
          <motion.div className="btn btn_secondary" variants={btnGroup} whileHover={{scale:1.05}} whileTap={{scale:0.95}}>Singup</motion.div>
        </motion.div>
      ...
      <motion.div className="right_content_wrapper">          
        <motion.img src="https://academy.avast.com/hs-fs/hubfs/New_Avast_Academy/the_most_secure_messaging_apps_academy/secure-messaging-01.png?width=1320&height=600&name=secure-messaging-01.png" alt="bg" initial={{x:200, opacity:0}} animate={{x:0, opacity:1}} transition={{duration:.5, delay:0.8}}/>
      </motion.div>
    </motion.div>
